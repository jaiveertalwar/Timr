...
function updateClock(days, hours, minutes) {
  ...
  if (days < 01) {
    ...
    $('.sharing-link').attr('href', 'https://twitter.com/share?text=I’ve wasted ' + days + ' days of my life watching TV shows. Calculate your time:&url=hhttps://timr.jtlrgroup.cf');
  } else {
